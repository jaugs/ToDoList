...
function createMenu() {
  ...
  let beerText = createDescription(
    "Best beer west of the Misty Mountains, enchanted by the great Wizard Gandalf himself! Comes in pints or Hobbit sized mugs."
  );
  ...
  let wineText = createDescription(
    "Imported white wine from the Old Winyards in the Southfarthing."
  );
  ...
  let breakfastText = createDescription(
    "Toast, fried egg, tomatos, beans, sausage and nice crispy bacon."
  );
  ...
  let chickenText = createDescription(
    "Hand-carved roast chicken, gravy drippings, golden mashed taters with mushy peas."
  );
  ...
  let stewText = createDescription(
    "Rich and hearty beef stew, with potatoes, carrots, peas and celery. Served with hunks of fresh baked bread."
  );
  ...
  let roomsText = createDescription(
    "Big People sized and even some lower-level Hobbit sized rooms available, each with personal fireplace to drive out the cold."
  );
  ...
  let stablesText = createDescription(
    "If you require a stall, let the innkeep know. We take the greatest care of all beasts of burden."
  );
